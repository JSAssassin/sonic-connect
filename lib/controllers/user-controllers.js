...
const getAllUsers = asyncErrorHandller(async (req, res, next) => {
...
// eslint-disable-next-line no-unused-vars
const getUser = asyncErrorHandller(async (req, res, next) => {
  const {id} = req.params;
...
const updatePassword = asyncErrorHandller(async (req, res, next) => {
