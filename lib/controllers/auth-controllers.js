...
const login = asyncErrorHandler(async (req, res, next) => {
  ...
  createResponse({ data, message, res, statusCode: 200, includeJwt: true });
});
...
const logout = asyncErrorHandler(async (req, res, next) => {
  ...
  createResponse({ res, message, statusCode: 200 });
});
...
const signup = asyncErrorHandler(async (req, res, next) => {
  ...
  const data = { user }
  createResponse({ data, message, res, statusCode: 201 });
});
...
const forgotPassword = asyncErrorHandler(async (req, res, next) => {
  ...
  try {
    ...
    createResponse({ message: responseMessage, res, statusCode: 200 });
  } catch (err) {
